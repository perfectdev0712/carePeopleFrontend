...
export default function Register() {
    return (
        <Box className="auth-register d-flex">
            <Box className="register-main-card text-align-center pt-5">
                <Box>
                    <Button className="bg-theme color-white text-capitalize register-btn" onClick={(e) => history.push("/client-register")}> Wants to hire ? </Button>
                </Box>
                <Box className="mt-3">
                    <Button className="bg-theme color-white text-capitalize register-btn" onClick={(e) => history.push("/worker-register")}> Wants to work ? </Button>
                </Box>
