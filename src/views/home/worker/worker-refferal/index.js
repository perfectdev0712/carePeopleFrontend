...
export default function WorkerRefferal() {
  ...
  return (
    <Container className="mt-1 mb-1 worker-referal">
      <Card className="p-2 theme-border theme-box-shadow">
        <CardContent>
          ...
          <Box className="d-flex">
            <Button variant="contained" fullWidth className="bg-theme color-white m-1" onClick={() => SetMailInvite(true)}>
              <Add />
              <Typography>Invite A Friend</Typography>
            </Button>
            <Button variant="contained" fullWidth className="m-1" onClick={() => SetPhoneInvite(true)}>
              <PhoneAndroid />
          ...
          <Box>
            ...
            <Box className="theme-border theme-border-radius p-1">
              ...
              <Box>
                <Box className="d-flex justify-content-between align-items-center referal-item bg-eee pl-1 pr-1">
          ...
          <Box className="mt-2">
            ...
            <Box className="theme-border theme-border-radius p-1">
              <TextField fullWidth variant="outlined" label="Search" />
              <Box>
                <Typography className="text-align-center referal-item bg-eee">No Active referral found</Typography>
              </Box>
            </Box>
          </Box>
        </CardContent>
